...
const {
    ...
    getParent,
    designationsEqual
} = require('../src/mpc_designation');

let passed = 0;
let failed = 0;

function testToReport(input, expected, desc) {
    try {
...
function testFromReport(input, expected, desc) {
    try {
...
function testHasFragment(input, expected, desc) {
...
function testGetFragment(input, expected, desc) {
    try {
...
function testGetParent(input, expected, desc) {
    try {
...
function testEqual(d1, d2, expected, desc) {
...
console.log('=== MPC Designation Helper Function Tests (JavaScript) ===');
console.log();
