...
public class TestHelpers {
    ...
    private static void testToReport(String input, String expected, String desc) {
        try {
            String result = MPCDesignation.toReportFormat(input);
            if (result.equals(expected)) {
                System.out.println("  PASS: toReportFormat(\"" + input + "\") -> \"" + result + "\"");
                passed++;
            } else {
                System.out.println("  FAIL: toReportFormat(\"" + input + "\"): expected \"" + expected + "\", got \"" + result + "\"");
                failed++;
            }
        } catch (Exception e) {
            System.out.println("  FAIL: toReportFormat(\"" + input + "\"): error - " + e.getMessage());
            failed++;
        }
    }

    private static void testFromReport(String input, String expected, String desc) {
        try {
            String result = MPCDesignation.fromReportFormat(input);
            if (result.equals(expected)) {
                System.out.println("  PASS: fromReportFormat(\"" + input + "\") -> \"" + result + "\"");
                passed++;
            } else {
                System.out.println("  FAIL: fromReportFormat(\"" + input + "\"): expected \"" + expected + "\", got \"" + result + "\"");
                failed++;
            }
        } catch (Exception e) {
            System.out.println("  FAIL: fromReportFormat(\"" + input + "\"): error - " + e.getMessage());
            failed++;
        }
    }

    private static void testHasFragment(String input, boolean expected, String desc) {
        boolean result = MPCDesignation.hasFragment(input);
        if (result == expected) {
            System.out.println("  PASS: hasFragment(\"" + input + "\") -> " + result);
            passed++;
        } else {
            System.out.println("  FAIL: hasFragment(\"" + input + "\"): expected " + expected + ", got " + result);
            failed++;
        }
    }

    private static void testGetFragment(String input, String expected, String desc) {
        try {
            String result = MPCDesignation.getFragment(input);
            if (result.equals(expected)) {
                System.out.println("  PASS: getFragment(\"" + input + "\") -> \"" + result + "\"");
                passed++;
            } else {
                System.out.println("  FAIL: getFragment(\"" + input + "\"): expected \"" + expected + "\", got \"" + result + "\"");
                failed++;
            }
        } catch (Exception e) {
            System.out.println("  FAIL: getFragment(\"" + input + "\"): error - " + e.getMessage());
            failed++;
        }
    }

    private static void testGetParent(String input, String expected, String desc) {
        try {
            String result = MPCDesignation.getParent(input);
            if (result.equals(expected)) {
                System.out.println("  PASS: getParent(\"" + input + "\") -> \"" + result + "\"");
                passed++;
            } else {
                System.out.println("  FAIL: getParent(\"" + input + "\"): expected \"" + expected + "\", got \"" + result + "\"");
                failed++;
            }
        } catch (Exception e) {
            System.out.println("  FAIL: getParent(\"" + input + "\"): error - " + e.getMessage());
            failed++;
        }
    }

    private static void testEqual(String d1, String d2, boolean expected, String desc) {
        boolean result = MPCDesignation.designationsEqual(d1, d2);
        if (result == expected) {
            System.out.println("  PASS: designationsEqual(\"" + d1 + "\", \"" + d2 + "\") -> " + result);
            passed++;
        } else {
            System.out.println("  FAIL: designationsEqual(\"" + d1 + "\", \"" + d2 + "\"): expected " + expected + ", got " + result);
            failed++;
        }
    }

    public static void main(String[] args) {
        System.out.println("=== MPC Designation Helper Function Tests (Java) ===");
        System.out.println();

        // Test toReportFormat
        System.out.println("--- toReportFormat ---");
        ...
        System.out.println();
        System.out.println("--- fromReportFormat ---");
        ...
        System.out.println();
        System.out.println("--- designationsEqual ---");
